        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-login">
                <div class="panel-heading">
                    <div class="row" >
                        <div class="col-xs-4" style="margin-left: -3px;">
                            <a style="font-size: 70px" href="#" class="active" id="login-form-link">Login</a>
                        </div>
                        <div class="col-xs-4" style="margin-left: -42px;">
                            <span style="font-size: 70px">/</span>
                        </div>
                        <div class="col-xs-4" style="margin-left: -71px;">
                            <a style="font-size: 70px" href="#" id="register-form-link">Register</a>
                        </div>
                    </div>
                    <hr>
                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6 col-sm-offset-3">
                                            <input type="submit"
                                                   style="background-color: #EC7A5C;width: 223%;margin-left: -151px;"
                                                   name="login-submit"
                                                   id="login-submit"
                                                   tabindex="4"
