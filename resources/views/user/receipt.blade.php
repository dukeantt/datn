...
<div class="invoice-box" style="margin-top: 180px; margin-bottom: 30px">
    <img src="{{asset('img/logoFashionVietnam.jpg')}}" style="max-width: 30%">
    <hr>
    <table cellpadding="0" cellspacing="0">
        <tr class="top">
            <td colspan="2">
                <table>
                    <tr>
                        <p>Cảm ơn quý khách đã đặt hàng tại Fashion Vietnam. Đơn hàng #{{$order -> id}} của quý khách đã được tiếp nhận và đang trong quá trình xử lý.
                            Fashion Vietnam sẽ thông báo đến quý khách ngay khi hàng chuẩn bị được giao.</p>
                        <br>
