    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 p-b-30">
                ...
                <p class="p-b-28">
                    Chúng tôi luôn mong muốn đem lại hiệu quả , sự tin tưởng và an tâm của khách hàng mỗi khi sử dụng sản phẩm của Fashion Vietnam
                </p>

                <p class="p-b-28">
                    Phương Châm Của Fashion Vietnam :
                </p>
